...
const username = 'adefila'
const password = 'adefila'
const dbName = 'store'
let db = null

// Connect to MongoDB database
async function main () {
  const client = new MongoClient(`mongodb+srv://${username}:${password}@cluster0.sfmrkbw.mongodb.net/cw-individual?retryWrites=true&w=majority`)
  try {
